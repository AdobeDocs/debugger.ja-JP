---
title: サマリ画面
description: Adobe Debuggerの概要画面の説明
...
ウィンドウの上部にあるタブの隣の青い番号は、おこなわれたサーバー呼び出しの数を表します。You can reset these to zero by clicking **[!UICONTROL Clear All Requests]** within the respective tab.
