...
Debugger はどの Web ページ上でも実行できますが、拡張機能で非公開データを使用するには、開いている Chrome タブのいずれかで Experience Cloud に認証されている必要があります。

## 使用例 {#section-9fcd0583ed184943a8f0c2d3c00658e0}

Experience Platform Debugger を使用して、Experience Cloud ソリューションの実装方法を理解するのに役立つ情報を収集します。以下に例を示します。
