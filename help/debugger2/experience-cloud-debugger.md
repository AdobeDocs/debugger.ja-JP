...
seo-title: Adobe Experience Cloud Debugger 2.0 Chrome および Firefox 拡張機能
title: Adobe Experience Cloud Debugger 2.0 拡張機能
...
# Adobe Experience Cloud Debugger 2.0 拡張機能 {#adobe-experience-cloud-debugger-extension}

[Adobe Experience Cloud Debugger 2.0 拡張機能（Chrome](https://chrome.google.com/webstore/detail/adobe-experience-cloud-de/ocdmogmohccmeicdhlhhgepeaijenapj) および [Firefox](https://addons.mozilla.org/ja/firefox/addon/adobe-experience-platform-dbg/) 用）は、Web ページを調べ、ユーザーが Experience Cloud ソリューションの実装方法に関する問題を見つけるのを支援します。

以下のようなワークフローに対して、他の Adobe Activation ソリューションと共に Adobe Experience Cloud Debugger 2.0 拡張機能を使用します。
