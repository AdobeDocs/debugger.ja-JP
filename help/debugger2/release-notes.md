...
<table id="table_96AEBFF29F3D40CAA859133B22756B0C"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Debugger に <a href="summary.md#section-82bc57440406461ebf27a16855b71655" format="dita" scope="local">Auditor テスト</a>を追加しました </p> </td> 
  </tr> 
  <tr> 
...
* Debugger ウィンドウが閉じていても、Debugger が埋め込みコードを置き換え続けていた問題を修正しました。
...
<table id="table_9AC6DE90AF4345DFA707BFBA1E58C328"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>「ツール」タブから、任意のページで Launch を動的に挿入して、Launch がインストールされていないページをテストできます。 </p> </td> 
  </tr> 
  <tr> 
...
* Debugger が各ページに _satellite を挿入していた問題を修正しました。
